...
public class GeraAutomato {
	...
	/**
         ...
         */
	public static AFN geraAFN(String expressao1) throws EmptyStackException{
	...
	/**
         * Faz a operacao OU.
         */
	private static void OperacaoOu() throws EmptyStackException{
		
            //System.out.println(pilhaAFN.size());
